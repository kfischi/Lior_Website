...
export const metadata: Metadata = {
  ...
  description:
    "עורכת דין פלילית מובילה בישראל — ליאור קלואי ארז. ניסיון של עשרות שנים בהגנה פלילית: עבירות סמים, אלימות, כלכליות ותעבורה. ייעוץ חסוי ראשוני ללא עלות. זמינה 24/7.",
  keywords: [
    "עורכת דין פלילית",
    "עורך דין פלילי",
    "הגנה פלילית",
  ...
  openGraph: {
    ...
    description:
      "הגנה פלילית מקצועית ואגרסיבית. זמינה 24/7. ייעוץ ראשוני ללא עלות.",
  ...
  twitter: {
    ...
    description: "הגנה פלילית מקצועית. זמינה 24/7.",
    images: ["/og-image.jpg"],
  },
  verification: {
  ...
  "@graph": [
    {
      ...
      telephone: process.env.NEXT_PUBLIC_LAWYER_PHONE || "+972-50-0000000",
      ...
      priceRange: "$$",
      description:
        "עורכת דין פלילית בכירה עם ניסיון של עשרות שנים. מתמחה בהגנה פלילית, עבירות סמים, אלימות, עבירות כלכליות ותעבורה. זמינה 24/7.",
      knowsAbout: [
