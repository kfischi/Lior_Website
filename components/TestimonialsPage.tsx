...
const testimonials = [
  {
    quote:
      "הגעתי למשרד אחרי שנעצרתי בשתיים בלילה. תוך שעה היה עורך דין לצדי. התיק נסגר ללא כתב אישום — לא האמנתי שזה אפשרי.",
    initials: "א.כ.",
...
export default function TestimonialsPage() {
  ...
  return (
    <>
      {/* ── Page Hero ──────────────────────────────────────────────────────── */}
      <div
        className="relative bg-noir-bg pt-32 pb-20 px-6 md:px-12 overflow-hidden"
      ...
      {/* ── Testimonials Grid ──────────────────────────────────────────────── */}
      <section className="bg-noir-bg py-20 px-6 md:px-12" dir="rtl">
